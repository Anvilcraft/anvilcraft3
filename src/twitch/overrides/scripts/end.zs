mods.extendedcrafting.CombinationCrafting.addRecipe(<extendedcrafting:material:32>, 10000000, <projectex:matter:11>, [<alchemistry:ingot:100>, <lucraftcore:ingot_uru>, <tconstruct:ingots:2>, <thermalfoundation:material:167>, <extrautils2:unstableingots>, <extendedcrafting:material:48>, <extendedcrafting:material:24>, <simplyjetpacks:metaitemmods:3>, <enderio:item_alloy_endergy_ingot:3>, <mysticalagradditions:insanium:2>, <astralsorcery:itemcraftingcomponent:1>, <botania:manaresource:14>, <deepmoblearning:glitch_infused_ingot>, <draconicevolution:draconic_ingot>, <bigreactors:ingotludicrite>, <avaritia:resource:6>]);
